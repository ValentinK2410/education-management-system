...
@section('title', 'Создание учебного заведения')
@section('page-title', 'Создать учебное заведение')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-building me-2"></i>Создание учебного заведения
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.institutions.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Создать учебное заведение
                            </button>
                        </div>
                    </form>
                </div>
