...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'Скрывать ссылки на пользователей', 'slug' => 'hide_user_links', 'description' => 'Право на скрытие ссылок на пользователей в интерфейсе'],
            ['name' => 'Видеть раздел "Пользователи" в боковой панели', 'slug' => 'view_sidebar_users', 'description' => 'Право на отображение ссылки "Пользователи" в боковой панели'],
            ['name' => 'Видеть раздел "Учебные заведения" в боковой панели', 'slug' => 'view_sidebar_institutions', 'description' => 'Право на отображение ссылки "Учебные заведения" в боковой панели'],
            ['name' => 'Видеть раздел "Программы" в боковой панели', 'slug' => 'view_sidebar_programs', 'description' => 'Право на отображение ссылки "Программы" в боковой панели'],
            ['name' => 'Видеть раздел "Курсы" в боковой панели', 'slug' => 'view_sidebar_courses', 'description' => 'Право на отображение ссылки "Курсы" в боковой панели'],
            ['name' => 'Видеть раздел "Роли" в боковой панели', 'slug' => 'view_sidebar_roles', 'description' => 'Право на отображение ссылки "Роли" в боковой панели'],
            ['name' => 'Видеть раздел "Отзывы" в боковой панели', 'slug' => 'view_sidebar_reviews', 'description' => 'Право на отображение ссылки "Отзывы" в боковой панели'],
            ['name' => 'Видеть раздел "Шаблоны сертификатов" в боковой панели', 'slug' => 'view_sidebar_certificates', 'description' => 'Право на отображение ссылки "Шаблоны сертификатов" в боковой панели'],
            ['name' => 'Видеть раздел "Архив пользователей" в боковой панели', 'slug' => 'view_sidebar_archive', 'description' => 'Право на отображение ссылки "Архив пользователей" в боковой панели'],
